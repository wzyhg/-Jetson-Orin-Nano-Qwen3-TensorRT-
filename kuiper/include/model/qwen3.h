...
class Qwen3Model : public Model {
 ...
 private:
  base::Status forward_internal(const tensor::Tensor& input, const tensor::Tensor& pos_tensor,
                                int& next, bool need_logits) const;
  ...
  base::Status validate_model_file_size(size_t file_size) const override;
